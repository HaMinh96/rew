...
`)},xn={root:function(t){var n=t.props,o=t.instance;return["p-badge p-component",{"p-badge-circle":v.isNotEmpty(n.value)&&String(n.value).length===1,"p-badge-dot":v.isEmpty(n.value)&&!o.$slots.default,"p-badge-sm":n.size==="small","p-badge-lg":n.size==="large","p-badge-xl":n.size==="xlarge","p-badge-info":n.severity==="info","p-badge-success":n.severity==="success","p-badge-warn":n.severity==="warn","p-badge-danger":n.severity==="danger","p-badge-secondary":n.severity==="secondary","p-badge-contrast":n.severity==="contrast"}]}},Tn=w.extend({name:"badge",theme:Pn,classes:xn}),On={name:"BaseBadge",extends:R,props:{value:{type:[String,Number],default:null},severity:{type:String,default:null},size:{type:String,default:null}},style:Tn,provide:function(){return{$pcBadge:this,$parentInstance:this}}},pn={name:"Badge",extends:On,inheritAttrs:!1};function Cn(e,t,n,o,r,i){return C(),A("span",x({class:e.cx("root")},e.ptmi("root")),[V(e.$slots,"default",{},function(){return[fn(cn(e.value),1)]})],16)}pn.render=Cn;var jn=`
.p-icon {
